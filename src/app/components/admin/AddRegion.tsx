"use client";
import { addRegion, getAllCountry } from "@/actions/admin";
...
export default function AddRegion({ opened, onClose }: AddRegionProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.error) {
        ...
        toast.success(result.message || "Region added successfully");
        refresh();
        onClose();
        setFormData({
          name: "",
